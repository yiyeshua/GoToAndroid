package com.pili.basemodel.retrofit;
...
public class OkHttp3Utils {
    ...
    //设置缓存目录
    private static File cacheDirectory = new File(AppUtils.getAppContext().getCacheDir().getAbsolutePath(), "MyCache");
    ...
    private static class MyIntercepter implements Interceptor {
        ...
        public Response intercept(Chain chain) throws IOException {
            ...
            Request newRequest = oldRequest.newBuilder()
                    ...
                    .build();
            //ysl-----end
            if (!isNetworkReachable(AppUtils.getAppContext())) {
                Toast.makeText(AppUtils.getAppContext(), "暂无网络", Toast.LENGTH_SHORT).show();
    ...
    private static class CookiesManager implements CookieJar {
        private final PersistentCookieStore cookieStore = new PersistentCookieStore(AppUtils.getAppContext());
